...
const BaseSearchContainer = () => {
    ...
    // console.log("🚀 ~ file: BaseSearchContainer.js ~ line 16 ~ BaseSearchContainer ~ queryParams", queryParams)
    
    const [qParam, setQParam] = useState(queryParams.q)
    // console.log("🚀 ~ file: BaseSearchContainer.js ~ line 19 ~ BaseSearchContainer ~ qParam", qParam)
